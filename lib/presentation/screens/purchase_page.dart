// File: lib/presentation/pages/purchase_page.dart
...
class _PurchasePageState extends State<PurchasePage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<PurchaseCubit, PurchaseState>(
      listener: (context, state) {
        ...
        // ✅ Tambahkan listener untuk state PurchaseDeleted
        if (state is PurchaseDeleted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('${state.productName} berhasil dihapus'),
      ...
      builder: (context, state) {
        ...
        // ✅ Tampilkan FloatingActionButton untuk admin & kasir
        bool canCRUD = userRole == 'admin' || userRole == 'kasir';
                  ...
                  child: isLoading
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _buildProductCard(product, canCRUD);
                          },
                        ),
                ),
              ],
  ...
  Widget _buildProductCard(Map<String, dynamic> product, bool canCRUD) {
    return Container(
  ...
  // ========================================
  // EDIT PRODUCT DIALOG (Tanpa Stok + Tombol Delete)
  // ========================================
    ...
    showDialog(
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          actions: [
            // ✅ TOMBOL DELETE DI DALAM FORM EDIT
            TextButton(
              onPressed: () {
                // Konfirmasi delete
                showDialog(
                    ...
                    actions: [
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          // ✅ Kirim nama produk untuk snackbar
                          await this.context.read<PurchaseCubit>().deleteProduct(
                            product['id'],
                            currentImageUrl,
                            product['name'], // Tambahkan parameter nama produk
                          );
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.red,
